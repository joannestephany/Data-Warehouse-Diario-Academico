...
CREATE TABLE TB_ALUNO_TURMA(
	ID_TURMA INT,
	ID_ALUNO INT,
	STATUS VARCHAR(10) CHECK (STATUS IN ('APROVADO','REPROVADO','TRANCADO'))
);
CREATE TABLE TB_TURMA(
	...
	ANO INT,
	SEMESTRE INT,
	NOME_TURMA VARCHAR(10) -- ISSO � NOVO, PENSAR O QUE FAZER
);

CREATE TABLE TB_PROFESSOR(
	ID_PROFESSOR INT IDENTITY (1,1) PRIMARY KEY,
	MATRICULA_PROFESSOR VARCHAR(12) NOT NULL, -- MUDEI PARA VARCHAR
