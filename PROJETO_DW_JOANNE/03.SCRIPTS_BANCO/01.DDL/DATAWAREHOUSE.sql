...
CREATE TABLE FATO_APROVACAO_PROFESSOR_ANO(
	ID_PROFESSOR INT,
	ID_ANO INT,
	TOTAL_APROVACAO INT
);

ALTER TABLE FATO_APROVACAO_PROFESSOR_ANO
ADD CONSTRAINT FK_FATO_APROVACAO_PROFESSOR_ANO_TO_TEMPO
FOREIGN KEY (ID_ANO) REFERENCES DIM_TEMPO (ID_TEMPO) --TEMPO

ALTER TABLE FATO_APROVACAO_PROFESSOR_ANO --PROFESSOR
ADD CONSTRAINT FK_FATO_APROVACAO_PROFESSOR_ANO_TO_PROFESSOR
FOREIGN KEY (ID_PROFESSOR) REFERENCES DIM_PROFESSOR (ID_PROFESSOR)
