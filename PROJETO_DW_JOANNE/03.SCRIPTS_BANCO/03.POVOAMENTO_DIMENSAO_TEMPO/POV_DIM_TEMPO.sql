...
BEGIN
	...
	BEGIN
			...
			SELECT @NOME_SEMESTRE = CASE
				...
				WHEN @SEMESTRE = 3 THEN 'TERCEIRO SEMESTRE'
				WHEN @SEMESTRE = 4 THEN 'QUARTO SEMESTRE' 
				END
...
CREATE OR ALTER PROCEDURE RODAR_DIMENSAO_TEMPO(@ANO_INICIO INT, @ANO_FIM INT)
AS
BEGIN
	EXEC sp_insert_SEMESTRE @ANO_INICIO, @ANO_FIM -- DEU CERTO POR MES
	EXEC sp_insert_ANO @ANO_INICIO, @ANO_FIM  -- DEU CERTO POR ANO
END

EXEC RODAR_DIMENSAO_TEMPO 2000, 2022
